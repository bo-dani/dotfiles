...
# Allows you to cd into the directory just by typing it.
shopt -s autocd
...
pacins() {
	pacman -Slq | \
	xargs --verbose -a <( fzf --border --preview 'pacman -Si {}' ) -ro sudo pacman -S --needed
}

# Install from AUR
aurins() {
	yay -Slq | \
	xargs --verbose -a <( fzf --border --preview 'yay -Si {}' ) -ro yay -S --needed
}
